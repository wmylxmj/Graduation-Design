...
class SPEModel(object):
    ...
    def sample(self, save_folder='samples', epoch=1, batch=1):
        ...
        heatmap = np.uint8(np.rint(np.minimum(heatmap, 255)))
...
spe = SPEModel(layers=8, pretrained_weights=None)
