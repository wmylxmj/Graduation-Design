    ...
    def __init__(self):
        ...
        for line in lines:
            ...
            if c in ["0", "1", "2", "14", "15", "16"]:
                ...
                pass
            pass
        self.train_txt_array = np.uint8(train_txt_array)
        ...
        for line in lines:
            ...
            if c in ["0", "1", "2", "14", "15", "16"]:
                ...
                pass
            pass
        self.val_txt_array = np.uint8(val_txt_array)
        self.n_frames = max([np.squeeze(np.max(self.train_txt_array[:, 1])), \
                             np.squeeze(np.max(self.val_txt_array[:, 1]))])
